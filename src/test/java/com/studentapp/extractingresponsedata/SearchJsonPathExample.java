...
public class SearchJsonPathExample {
    ...
    @Test
    public void test007() {
        List<HashMap<String , ?>> list = response.extract().path("data.findAll{it.name=='Duracell - AA Batteries (8-Pack)'}");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The values for product name 'Duracell - AA Batteries (8-Pack)' are: "+ list);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test009() {
        List<String> name= response.extract().path("data.findAll{it.price < 16.99}.name");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The names of products that price is less than 16.99 are: " +name );
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test010() {
        List<String> name= response.extract().path("data.findAll{it.name==~/Ene.*/}.manufacturer");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The manufacturer of products whose name Start = Ene are: " +name );
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test011() {
        List<Integer> price = response.extract().path("data.findAll{it.name==~/.*Black/}.pirce");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test012() {
        List<Integer> id = response.extract().path("data.findAll{it.name=='Energizer - N Cell E90 Batteries (2-Pack)'}");
        System.out.println("------------------StartingTest---------------------------");
